...
namespace DataArt.Atlas.CallContext.Correlation
{
    public static class CorrelationContext
    {
        ...
        public static CorrelationId CorrelationId
        {
            get
            {
                return (CorrelationId)System.Runtime.Remoting.Messaging.CallContext.LogicalGetData(CorrelationIdName);
            }
        ...
        {
            CorrelationId = value != null ? new CorrelationId(Guid.Parse(value)) : new CorrelationId();
        }
    }
}
