...
{
    public static class AutofacConfigValidator<T> where T : ApplicationSettings, new()
    {
        ...
        public static void Validate<TServiceSettings>(Action<ContainerBuilder> configure) where TServiceSettings : class, new()
        {
