...
namespace DataArt.Atlas.Infrastructure.OData
{
    public static class ODataExtensions
    {
        ...
        public static IEnumerable<KeyValuePair<string, string>> MapODataFilterEnum<TSourceEnum, TDestinationEnum>(this IEnumerable<KeyValuePair<string, string>> oDataQuery, string clientFieldName) where TSourceEnum : struct where TDestinationEnum : struct
        {
