...
{
    internal sealed class InternalRequestFactory : BaseRequestFactory, IInternalRequestFactory
    {
        public InternalRequestFactory(string serviceKey, IServiceDiscovery serviceDiscovery,
