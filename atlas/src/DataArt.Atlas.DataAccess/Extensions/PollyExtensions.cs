...
namespace DataArt.Atlas.DataAccess.Extensions
{
    public static class PollyExtensions
    {
        ...
        public static RetryPolicy RetryForeverWithEntityReloadAsync(this PolicyBuilder policyBuilder, Action<Exception, Context> onRetry)
        {
        ...
        public static RetryPolicy RetryForeverWithEntityReloadAsync(this PolicyBuilder policyBuilder, Action<Exception> onRetry)
        {
