...
namespace DataArt.Atlas.DataAccess.EntityFramework.Messaging
{
    public abstract class IdempotentMessageConsumerDbContext<TContext> : BaseDbContext<TContext> where TContext : DbContext
    {
