        ...
        where TService : ServiceShell, new()
    {
            ...
            where TT : IConsumerBusType
        {
            ShellInitializationParameters.ServiceBusParameters.Add(
                new Tuple<Type, IServiceBusInitiator>(typeof(TT),
        ...
        public Application<TService> UseJsonMediaTypeFormatter(JsonMediaTypeFormatter formatter)
        {
            ShellInitializationParameters.JsonFormatterParameter = formatter;
            return this;
        }
