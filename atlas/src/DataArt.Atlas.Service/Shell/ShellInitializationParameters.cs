...
namespace DataArt.Atlas.Service.Shell
{
    internal class ShellInitializationParameters
    {
        ...
        public JsonMediaTypeFormatter JsonFormatterParameter { get; set; }
        ...
        public ShellInitializationParameters()
        {
            ...
            JsonFormatterParameter = new JsonMediaTypeFormatter();
        ...
        public ContainerBuilder GetContainerBuilder()
        {
            ...
            builder.RegisterInstance(JsonFormatterParameter).AsSelf().SingleInstance();
